...
export function buttonClassName(
  ...
  return joinClasses(
    'inline-flex items-center justify-center gap-2 border-2 border-[#2D2A20] font-bold uppercase tracking-[1px] shadow-[3px_3px_0_#2D2A20] transition-all duration-150 hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[2px_2px_0_#2D2A20] disabled:pointer-events-none disabled:translate-x-0 disabled:translate-y-0 disabled:opacity-60 disabled:shadow-none',
    tone === 'primary'
