...
export function ClaimUsernameModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/30 p-4 sm:p-0">
      <div className="w-full sm:max-w-sm rounded-lg border-2 border-[var(--border-strong)] bg-[var(--bg-surface)] p-5 sm:p-6 shadow-xl">
        ...
        <input
          ...
          maxLength={20}
          className="mt-3 w-full rounded-md border-2 border-[var(--border-subtle)] bg-white px-3 py-3 sm:py-2 text-base sm:text-sm font-mono outline-none focus:border-[var(--accent-primary)]"
        />
        ...
        <button
          ...
          className="mt-3 w-full rounded-md border-2 border-[var(--border-strong)] bg-[var(--accent-primary)] px-4 py-3 sm:py-2 text-sm font-semibold disabled:opacity-50"
        >
